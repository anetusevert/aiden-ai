...
> = {
  LITIGATION_CASE_FILING: {
    ...
    doc_type: 'docx',
    template: 'statement_of_claim',
  },
  LITIGATION_COURT_HEARINGS: {
    title: 'Hearing Memorandum',
    doc_type: 'docx',
    template: 'memorandum',
  },
  LITIGATION_EVIDENCE: {
    ...
    doc_type: 'docx',
    template: 'evidence_bundle',
  },
  LITIGATION_APPEAL: {
    title: 'Appeal Memorandum',
    doc_type: 'docx',
    template: 'appeal_memorandum',
  },
  LITIGATION_GOVERNMENT: {
    title: 'Board of Grievances Filing',
    doc_type: 'docx',
    template: 'government_filing',
  },
  CORPORATE_FORMATION: {
    title: 'Articles of Association',
    doc_type: 'docx',
    template: 'articles_of_association',
  },
  CORPORATE_CONTRACTS: {
    title: 'Contract Draft',
    doc_type: 'docx',
    template: 'contract_draft',
  },
  CORPORATE_MA: {
    title: 'M&A Transaction Documents',
    doc_type: 'docx',
    template: 'ma_documents',
  },
  CORPORATE_FDI: {
    title: 'Investment Structure Memo',
    doc_type: 'docx',
    template: 'fdi_memo',
  },
  CORPORATE_GOVERNANCE: {
    ...
    doc_type: 'docx',
    template: 'governance_report',
  },
  COMPLIANCE_PRIVACY: {
    title: 'Privacy Compliance Report',
    doc_type: 'docx',
    template: 'privacy_report',
  },
  COMPLIANCE_AML: {
  ...
  COMPLIANCE_SAUDIZATION: {
    title: 'Saudization Plan',
    doc_type: 'docx',
    template: 'saudization_plan',
  },
  ...
  EMPLOYMENT_DISPUTE: {
    title: 'Labor Dispute Filing',
    doc_type: 'docx',
    template: 'labor_dispute',
  },
  EMPLOYMENT_RESTRUCTURING: {
    title: 'Restructuring Plan',
    doc_type: 'docx',
    template: 'restructuring_plan',
  },
  EMPLOYMENT_CONTRACT: {
  ...
  EMPLOYMENT_COMPENSATION: {
    ...
    doc_type: 'xlsx',
    template: 'compensation_analysis',
  },
  ...
  ARBITRATION_CLAUSE: {
    title: 'Arbitration Clause Draft',
    doc_type: 'docx',
    template: 'arbitration_clause',
  },
  ARBITRATION_CLAIMANT: {
    title: 'Statement of Claim (Arbitration)',
    doc_type: 'docx',
    template: 'arb_claim',
  },
  ARBITRATION_RESPONDENT: {
    ...
    doc_type: 'docx',
    template: 'arb_defence',
  },
  ARBITRATION_FOREIGN: {
    title: 'Foreign Judgment Recognition Filing',
    doc_type: 'docx',
    template: 'foreign_judgment',
  },
  ARBITRATION_MEDIATION: {
    title: 'Mediation Brief',
    doc_type: 'docx',
    template: 'mediation_brief',
  },
  ENFORCEMENT_PROMISSORY: {
    title: 'Promissory Note Filing',
    doc_type: 'docx',
    template: 'promissory_filing',
  },
  ENFORCEMENT_JUDGMENT: {
    title: 'Judgment Enforcement Application',
    doc_type: 'docx',
    template: 'judgment_enforcement',
  },
  ENFORCEMENT_DEBT: {
    title: 'Debt Recovery Filing',
    doc_type: 'docx',
    template: 'debt_recovery',
  },
  ENFORCEMENT_BANKRUPTCY: {
    title: 'Bankruptcy Filing',
    doc_type: 'docx',
    template: 'bankruptcy_filing',
  },
  ENFORCEMENT_CROSS_BORDER: {
    title: 'Cross-Border Enforcement Filing',
    doc_type: 'docx',
    template: 'cross_border_enforcement',
  },
  RESEARCH_LEGAL: {
  ...
  RESEARCH_CLIENT_COMMS: {
    title: 'Client Communication',
    doc_type: 'docx',
    template: 'client_letter',
  },
  MANAGEMENT_CLIENT_INTAKE: {
    title: 'Client Intake Form',
    doc_type: 'docx',
    template: 'client_intake',
  },
  MANAGEMENT_BILLING: {
    title: 'Billing Report',
    doc_type: 'xlsx',
    template: 'billing_report',
  },
  MANAGEMENT_FIRM_COMPLIANCE: {
    title: 'Firm Compliance Checklist',
    doc_type: 'docx',
    template: 'firm_compliance',
  },
  MANAGEMENT_BUSINESS_DEV: {
    title: 'Business Development Plan',
    doc_type: 'docx',
    template: 'business_dev',
  },
  MANAGEMENT_TALENT: {
    title: 'Talent Plan',
    doc_type: 'docx',
    template: 'talent_plan',
  },
};
